...
def main():
    ...
    if cfg.MODEL.get('DENSE_HEAD', None) and cfg.MODEL.DENSE_HEAD.NAME == 'AnchorHeadMulti' and cfg.get('DATA_CONFIG_TAR', None):
        # Adapt
        if cfg.DATA_CONFIG.DATASET == 'WaymoDataset' \
                and cfg.DATA_CONFIG_TAR.DATASET == 'KittiDataset':
            cfg.DATA_CONFIG_TAR.CLASS_NAMES[0] = 'Car'
            cfg.MODEL.DENSE_HEAD.ANCHOR_GENERATOR_CONFIG[0]['class_name']  = 'Car'
            cfg.MODEL.DENSE_HEAD.RPN_HEAD_CFGS[0]['HEAD_CLS_NAME'][0] = 'Car'
        pass
